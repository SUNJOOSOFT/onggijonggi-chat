...
| `adt` | `audit` | 감사 | 알고리즘 | - |
| `ath` | `author` | 작성자 | 알고리즘 | - |
| `authz` | `authz` | - | 예외 | `author`의 `ath`와 충돌 |
| `bfr` | `before` | 이전 | 알고리즘 | - |
| `by` | `by` | 주체 | 알고리즘 | - |
