...
/********************************************************
 ...
 방 접근 거부는 구독에 대한 error 프레임(FORBIDDEN)으로 도착해 사유가 분명하다 — 핸드셰이크에는
 방이 없어(이슈 #161) 방 단위로 거부될 수 없다. 핸드셰이크 자체가 실패하면 브라우저가 이유를
 넘겨주지 않아(#4) 서버 장애와 구분되지 않으므로, 그쪽은 단정하지 않는 문구로 안내한다.
 *********************************************************/
