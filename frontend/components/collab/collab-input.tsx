...
/********************************************************
 ...
 1:1의 multimodal-input.tsx와 따로 두는 이유는 두 가지다. 그쪽은 localStorage 초안 보관을 함께
 지고, 이쪽은 보내지 못했을 때(끊김) 그 자리에서 알려야 한다. 전송 계약 자체는 이제 양쪽 다
 "완성된 발화 하나"라 합칠 여지가 생겼지만 이번 범위는 아니다.
 *********************************************************/
